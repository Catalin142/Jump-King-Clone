...
void Shader::load(const std::string& vertex_shader_filepath, const std::string& fragment_shader_filepath)
{
...
void Shader::set_uniform_vec2(const std::string& name, f32 x, f32 y)
{
	bind();
	u32 uniform_location = get_uniform_location(name);
...
void Shader::set_uniform_int(const std::string& name, i32 i)
{
	bind();
	u32 uniform_location = get_uniform_location(name);
